 ...
 */
	public function dispatch() {
		...
		throw new MissingShellMethodException(array('shells' => $shell, 'method' => $arg));
	}

/**
 * Get shells to use, either plugin shells or application shells
 *
 * All paths in the loaded shells paths are searched.
 *
