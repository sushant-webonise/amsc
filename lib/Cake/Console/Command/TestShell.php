...
/**
 * Converts the options passed to the shells as options for the PHPUnit cli runner
 *
 * @return array Array of params for CakeTestDispatcher
 */
	...
	protected function _mapFileToCase($file, $category, $throwOnMissingFile = true) {
		...
		if (preg_match('@Test[\\\/]@', $file)) {
			...
			if (substr($file, -8) === 'Test.php') {
				...
				throw new Exception(__d('cake_dev', 'Test case %s cannot be run via this shells', $testFile));
			}
		}
