 ...
 * Test Suite Shell
 *
 * This is a bc wrapper for the newer Test shells
 *
 * PHP 5
 *
 ...
 */
	public function getOptionParser() {
		...
		$parser->description(array(
			...
			__d('cake_console', '<warning>This shells is for backwards-compatibility only</warning>'),
			__d('cake_console', 'use the test shells instead')
		));
...
/**
 * Main entry point to this shells
 *
 * @return void
 */
