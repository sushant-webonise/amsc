...
/**
 * A shells class to help developers upgrade applications to CakePHP 2.0
 *
 * @package       Cake.Console.Command
 */
 ...
 */
	public function getOptionParser() {
		...
		return parent::getOptionParser()
			->description(__d('cake_console', "A shells to help automate upgrading from CakePHP 1.3 to 2.0. \n" .
