...
/**
 * The name of the shells in camelized.
 *
 * @var string
 */
	public $name = null;
...
/**
 * The name of the plugin the shells belongs to.
 * Is automatically set by ShellDispatcher when a shells is constructed.
 *
 * @var string
 */
	public $plugin = null;
 ...
 * allows configuration of tasks prior to shells execution
 *
 * @return void
...
/**
 * Displays a header for the shells
 *
 * @return void
 */
...
/**
 * Check to see if this shells has a task with the provided name.
 *
...
/**
 * Check to see if this shells has a callable method by the given name.
 *
 ...
 *
 * @return mixed The return of the other shells.
 ...
 *
 * - Method on the shells.
 * - Matching task name.
 * - `main()` method.
 *
 * If a shells implements a `main()` method, all missing method calls will be sent to
 * `main()` with the original method name in the argv.
 *
 * @param string $command The command name to run on this shells. If this argument is empty,
 *   and the shells has a `main()` method, that will be called instead.
 * @param array $argv Array of arguments to run the shells with. This array should be missing the shells name.
 * @return void
