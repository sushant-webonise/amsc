 ...
 */
/**
 * Object wrapper for outputting information from a shells application.
 ...
 *
 * You can format console output using tags with the name of the style to apply. From inside a shells object
 *
